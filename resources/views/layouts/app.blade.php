...
<head>
    ...
    @stack('styles') {{--Reserva el espacio para poder agregar hojas de estilo[@push] que no se requieran en todas tus vistas--}}
...
<body class="bg-gray-100">
  ...
  <header class="p-5 border-b bg-white shadow">
    ...
    <main class="container mx-auto mt-10">
            ...
            @yield('titulo') {{--los yield son contenedores--}}
            </h2>   
            @yield('contenido')
